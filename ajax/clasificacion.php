<?php
    ...
    if (isset($_GET['id'])){
        ...
        $query=mysqli_query($con, "SELECT * from r_clasificaciones where id='".$id_del."'");
        $count=mysqli_num_rows($query);
            if ($delete1=mysqli_query($con,"DELETE FROM r_clasificaciones WHERE id='".$id_del."'")){
            ?>
            ...
            <table class="table table-striped jambo_table bulk_action">
                <thead>
                    <tr class="headings">
                        ...
                        <th class="column-title">Simbolo/Nombre corto</th>
