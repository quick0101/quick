            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal form-label-left input_mask" method="post" id="upd" name="upd">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">imbolo/Nombre corto <span class="required">*</span>
                            </label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <input name="mod_description" id="mod_description" class="date-picker form-control col-md-7 col-xs-12" required placeholder="Descripción"></textarea>
                            </div>
                        </div>
