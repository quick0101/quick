    <div> <!-- Modal -->
        <button type="button" class="btn btn-default" data-toggle="modal" data-target=".bs-example-modal-lg-add"><i class="fa fa-plus-circle"></i> Comanzar ahora!</button>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal form-label-left input_mask" id="add_cliente" name="add_cliente">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                <input name="rtn" required type="text" class="form-control" placeholder="RTN">
                                <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
                        </div>
