<?php
    ...
    $categories =mysqli_query($con, "select * from r_categorias");
?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal form-label-left input_mask" method="post" id="add" name="add">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Cantidad inicial<span class="required">*</span></label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Unidad de Medida
                            </label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <select class="form-control" name="priority_id" >
                                  ...
                                  <?php foreach($priorities as $p):?>
                                    <option value="<?php echo $p['id']; ?>"><?php echo $p['name']." - (".$p['ndias']." dias)"; ?> </option>
                                  <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
